        ...
        <div className="text-center space-y-4">
          ...
          {isReal && (
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-duo-blue/10 rounded-full">
              ...
              <span className="text-sm text-duo-blue font-semibold">15 competition questions</span>
            </div>
          )}
        </div>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-eel mt-1">
                {isReal
                  ? 'These credentials are for the official competition with 15 questions. Students cannot use mock credentials for the official competition.'
    ...
    <div className="max-w-lg mx-auto space-y-6">
      ...
      <div className="text-center space-y-4">
        ...
        <div>
          ...
          <p className="text-wolf">
            {isReal
              ? 'Create credentials for the Official Fermi Competition with 15 questions.'
